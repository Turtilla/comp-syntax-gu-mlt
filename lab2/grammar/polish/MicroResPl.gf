...
oper
  ...
  conjVerb : Str -> Verb = \inf -> case inf of {
     czyt  +  "ać" => mkVerb inf (czyt + "am") (czyt + "asz") (czyt + "a") (czyt + "amy") (czyt + "acie") (czyt + "ają") ;  -- 1st conjugation
     umi  +  "eć" =>  mkVerb inf (umi + "em") (umi + "esz") (umi + "e") (umi + "emy") (umi + "ecie") (umi + "eją") ;  -- 2nd conjugation
     tani + "eć"  => mkVerb inf (tani + "eję") (tani + "ejesz") (tani + "eje") (tani + "ejemy") (tani + "ejcie") (tani + "eją") ;  -- 3rd conjugation
     mal  +  "ować" => mkVerb inf (mal + "uję") (mal + "ujesz") (mal + "uje") (mal + "ujemy") (mal + "ujecie") (mal + "ują") ;  -- 4th conjugation
     ciąg  +  "nąć" => mkVerb inf (ciąg + "nę") (ciąg + "niesz") (ciąg + "nie") (ciąg + "niemy") (ciąg + "niecie") (ciąg + "ną") ;  -- 5th conjugation
     rob  +  "ić" => mkVerb inf (rob + "ię") (rob + "isz") (rob + "i") (rob + "imy") (rob + "icie") (rob + "ią") ;  -- 6th A conjugation
     wierz  +  "yć" => mkVerb inf (wierz + "ę") (wierz + "ysz") (wierz + "y") (wierz + "ymy") (wierz + "ycie") (wierz + "ą") ;  -- 6th B conjugation
     widz  +  ("ieć"|"eć") => mkVerb inf (widz + "ę") (widz + "isz") (widz + "i") (widz + "imy") (widz + "icie") (widz + "ą") ;  -- 7th A conjugation
     leż  +  ("ieć"|"eć") => mkVerb inf (leż + "ę") (leż + "ysz") (leż + "y") (leż + "ymy") (leż + "ycie") (leż + "ą") ;  -- 7th B conjugation
     zysk  +  ("iwać"|"ywać") => mkVerb inf (zysk + "uję") (zysk + "ujesz") (zysk + "uje") (zysk + "ujemy") (zysk + "ujecie") (zysk + "ują") ;  -- 8th conjugation, in pres same as 4th (merge?)
     -- 9th conugation mutates the root https://pl.wiktionary.org/wiki/Aneks:J%C4%99zyk_polski_-_koniugacja_IX
     pi  +  "ć" => mkVerb inf (pi + "ję") (pi + "jesz") (pi + "je") (pi + "jemy") (pi + "jecie") (pi + "ją") ; -- 10th A conjugation
     l  +  "ać" => mkVerb inf (l + "eję") (l + "ejesz") (l + "eje") (l + "ejemy") (l + "ejecie") (l + "eją") ;  -- 10th B conjugation
